...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Multizap Chatbot, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  ...
  printf "\n"
  printf "\n"
  printf "${WHITE} 💻 Versão AKIRA BOT - Multizap Chat!${GRAY_LIGHT}"
