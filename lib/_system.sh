...
system_mv_folder() {
  ...
  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/chatbot.zip /home/deploy/${instancia_add}/
EOF
...
system_unzip_Multizap() {
  print_banner
  printf "${WHITE} 💻 Extraindo o Multizap Chatbot...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - deploy <<EOF
  unzip /home/deploy/${instancia_add}/chatbot.zip -d /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Multizap Chatbot...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do Multizap Chatbot...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o Multizap Chatbot...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Multizap Chatbot de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do Multizap Chatbot de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
